"""
Web Page: https://leetcode.com/problems/richest-customer-wealth/description/ 
...
class Solution:
    def maximumWealth(self, accounts: List[List[int]]) -> int:
        ...
        for customer in accounts:
            currentAccoutSum = sum(customer)
            if currentAccoutSum > theWealthestOne:
